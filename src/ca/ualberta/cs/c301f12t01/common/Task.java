 ...
 * 
 * This should be instantiated when you create a Task or reconstruct a task from
 * storage. Each task has its own id and a creator id to distinguish between
 * various tasks. Tasks are made up of Summary, Description, Requests and
 * whether it is shared. The summary is a brief description of the task. The
 * description is a lengthy description of the task. The requests are one or
 * more of the following three types, Text, Audio and Photo {@link Request}. The
 * shared is a boolean true or false whether to be shared or not.
 * 
...
public class Task implements Iterable<Request> {
	...
	/**
	 * Constructs a new task. This is used by the GUI. It takes in a user ID to
	 * keep track of who created the task.
	 * 
	 * @param user
	 */
	...
	/**
	 * Constructs a modified task. This is for when modifying. It takes in the
	 * old task to be modified to keep the same user ID and same UUID.
	 * 
	 * @param oldTask
	 */
	...
	/**
	 * Constructs a new task given a pre-existing task id. This will be done
	 * from storage side of code.
	 * 
	 * @param taskId
	 * @param user
	 */
	...
	/**
	 * Used to get the summary of a given task. The summary is a brief
	...
	/**
	 * Used to get the description of a given task. The description is a lengthy
	 * response describing in full detail what the task requires in terms of
	 * what type of text audio or photo responses be required.
	 * 
    ...
    public String toString() {
        ...
        return "<" + shared.name() + "-TASK (" + getId().toString() + "): " + getSummary() + 
        		", " + requestCount() + ">";
    }
}
